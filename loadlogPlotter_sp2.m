...
if handles.plotsaved == 1
    ...
    underscoreIndex = find(filename_plot_sp2 == '_');
    periodIndex = find(filename_plot_sp2 == '.');
    year_log = filename_plot_sp2((underscoreIndex(1) + 6):(underscoreIndex(1) + 9));
    month_log = filename_plot_sp2((underscoreIndex(1) + 3):(underscoreIndex(1) + 5));
    day_log = filename_plot_sp2((underscoreIndex(1) + 1):(underscoreIndex(1) + 2));
    num_log = filename_plot_sp2((underscoreIndex(end) + 1):(periodIndex - 1));
    
    element_sp2 = filename_plot_sp2(2:(underscoreIndex(1) - 1));
