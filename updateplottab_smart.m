...
elseif plotspecies2 == 1
    
    if sepspecies == 1
        
        plot(x1_points_sp2(stored_index_sp2),y1_points_sp2(stored_index_sp2),'x')
...
elseif plotspecies2 == 1
    ...
    if sepspecies == 1
        ...
        plot(x2_points_sp2(stored_index_sp2),y2_points_sp2(stored_index_sp2),'x')
...
elseif plotspecies2 == 1
    ...
    if sepspecies == 1
        ...
        plot(x3_points_sp2(stored_index_sp2),y3_points_sp2(stored_index_sp2),'x')
...
elseif plotspecies2 == 1
    ...
    if sepspecies == 1
        ...
        plot(x4_points_sp2(stored_index_sp2),y4_points_sp2(stored_index_sp2),'x')
...
elseif plotspecies2 == 1
    ...
    if sepspecies == 1
        ...
        plot(x5_points_sp2(stored_index_sp2),y5_points_sp2(stored_index_sp2),'x')
...
elseif plotspecies2 == 1
    ...
    if sepspecies == 1
        ...
        plot(x6_points_sp2(stored_index_sp2),y6_points_sp2(stored_index_sp2),'x')
